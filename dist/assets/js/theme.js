...
$(document).ready(function() {
  ...
  $(".swiper-js-container")[0] &&
    $(".swiper-js-container").each(function(i, swiperContainer) {
      ...
      var swiperDirection = !$swiper.data("swiper-direction")
        ? "horizontal"
        : $swiper.data("swiper-direction");
  ...
  $(".pricing-container")[0] &&
    $(".pricing-container button[data-pricing]").click(function() {
      ...
      if (!$this.hasClass("active")) {
        ...
        $("." + b.attr("class") + " button[data-pricing]").removeClass(
          "active"
        );
        $this.addClass("active");
  ...
  $('[data-animate-items="hover"]')[0] &&
    $('[data-animate-items="hover"]').hover(
      function() {
        var $this = $(this);
        ...
        elems.each(function() {
          ...
          setTimeout(function() {
            item
              .addClass("animated " + animationIn, 100)
      ...
      function() {
        ...
        elems.each(function() {
          ...
          setTimeout(function() {
            item
              .addClass("animated " + animationOut, 100)
              .on(animEndEv, function() {
    ...
    switch (action) {
      case "offcanvas-open":
        (target = $this.data("target")),
          ...
          $("body").append(
            '<div class="body-backdrop body-backdrop-dark backdrop-canvas" data-action="offcanvas-close" data-target=' +
              target +
              " />"
          );
        console.log("opened");
      ...
      case "search-open":
        ...
        $("body")
          ...
          .append(
            '<div class="body-backdrop body-backdrop-dark body-back-search" data-action="search-close" data-target="' +
              target +
              '" />'
          );
        break;
